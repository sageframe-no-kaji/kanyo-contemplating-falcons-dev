...
# Create streams.yaml
cat > admin/web/streams.yaml << 'EOF'
streams:
  harvard:
    name: "Harvard Falcon Cam"
    container_name: "kanyo-harvard-gpu"
    config_path: "/data/harvard/config.yaml"
    clips_path: "/data/harvard/clips"
    youtube_url: "https://www.youtube.com/watch?v=glczTFRRAK4"
    timezone: "-05:00"
    
  nsw:
    name: "NSW Falcon Cam"
    container_name: "kanyo-nsw-gpu"
    config_path: "/data/nsw/config.yaml"
    clips_path: "/data/nsw/clips"
    youtube_url: "https://www.youtube.com/watch?v=yv2RtoIMNzA"
    timezone: "+11:00"
EOF
...
cat > admin/docker-compose.yml << 'EOF'
services:
  admin:
    build: ./web
    ...
    volumes:
      ...
      # Stream data directories (production paths)
      - ${KANYO_HARVARD_ROOT:-/opt/services/kanyo-harvard}:/data/harvard:ro
      - ${KANYO_NSW_ROOT:-/opt/services/kanyo-nsw}:/data/nsw:ro
      
      # Development: mount source for hot reload
      - ./web/app:/app/app:ro
      - ./web/streams.yaml:/app/streams.yaml:ro
    environment:
      - KANYO_ENV=${KANYO_ENV:-development}
...
KANYO_HARVARD_ROOT=/opt/services/kanyo-harvard
KANYO_NSW_ROOT=/opt/services/kanyo-nsw
EOF
...
Note: Container management won't work locally (no kanyo containers on Mac), but templates and structure can be tested.
...
# Copy admin to services
cp -r admin /opt/services/kanyo-admin
